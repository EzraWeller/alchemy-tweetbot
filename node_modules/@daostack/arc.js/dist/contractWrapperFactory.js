...
class ContractWrapperFactory {
     ...
     */
    constructor(solidityContractName, wrapper, web3EventService) {
        this.solidityContractName = solidityContractName;
    ...
    new(...rest) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.ensureSolidityContract();
            const hydratedWrapper = yield new this.wrapper(this.solidityContract, this.web3EventService).hydrateFromNew(...rest);
    ...
    getHydratedWrapper(getWrapper, address) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let hydratedWrapper;
            if (ContractWrapperFactory.configService.get("cacheContractWrappers")) {
                ...
                if (address) {
                    hydratedWrapper = this.getCachedContract(this.solidityContractName, address);
                    if (hydratedWrapper) {
                        loggingService_1.LoggingService.debug(`ContractWrapperFactory: obtained wrapper from cache: ${hydratedWrapper.address}`);
                    }
                }
                if (!hydratedWrapper) {
                    hydratedWrapper = yield getWrapper();
                    if (hydratedWrapper) {
                        this.setCachedContract(this.solidityContractName, hydratedWrapper);
                    }
                }
    ...
    setCachedContract(name, wrapper) {
        if (wrapper) {
    ...
    ensureSolidityContract() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!this.solidityContract) {
                this.solidityContract = yield utils_1.Utils.requireContract(this.solidityContractName);
            }
        });
    }
}
 ...
 */
ContractWrapperFactory.contractCache = new Map();
exports.ContractWrapperFactory = ContractWrapperFactory;
//# sourceMappingURL=contractWrapperFactory.js.map